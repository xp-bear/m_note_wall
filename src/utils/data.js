...
export const wallType = [
  ...
  {
    name: "照片墙",
    slogan: "照片挂在墙上，笑声还留在空气里。",
  },
];
//分类标签
export const label = [
  ["全部", "留言", "目标", "梦想", "过去", "将来", "爱情", "亲情", "友情", "秘密", "信条", "无题"],
  ["留言", "目标", "梦想", "过去", "将来", "爱情", "亲情", "友情", "秘密", "信条", "无题"],
  ["全部", "我", "那个ta", "生活", "喜欢的", "值得纪念的", "我在的城市", "母校", "天空", "大海", "无题"],
...
//   "linear-gradient(180deg,#FA7EB6 0%,#F026A8 100%)",
...
//   "linear-gradient(180deg,#07FFA7 0%,#5ED52A 100%)",
